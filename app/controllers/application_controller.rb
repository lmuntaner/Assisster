...
class ApplicationController < ActionController::Base
  ...
  helper_method :current_doctor, :doctor_signed_in?
    ...
    def require_doctor_signed_in!
      redirect_to new_session_url unless doctor_signed_in?
    end
    
    def ensure_doctor_signed_in
      redirect_to root_url unless doctor_signed_in?
    end
